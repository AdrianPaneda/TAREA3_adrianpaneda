 ...
 * <p>
 * Proporciona la lógica de negocio para autenticación de usuarios (CU2) y
 * validación de unicidad de nombres de usuario (CU3).
 * </p>
 *
...
public class CredencialesService {
	...
	public boolean autenticar(String nombreUsuario, String password) {
		...
		if (!credenciales.isEmpty()) {
			autenticado = password.equals(credenciales.get().getPassword());
		}
